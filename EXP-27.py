import cv2
import numpy as np
image = cv2.imread(r"C:\Users\krish\OneDrive\Pictures\Screenshots\Screenshot 2024-07-27 140620.png")
img2 = cv2.imread(r"C:\Users\krish\OneDrive\Pictures\Screenshots\IMG-5.png")
print(image.shape)
